...
export default function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
            ...
            <motion.div 
                className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center mt-20"
                style={{ opacity }}
            >
                {/* TÍTULO GRANDÃO E IMPACTANTE */}
            <div className="mb-6 mt-16">
    <h1 className="text-white tracking-tight font-['Funnel Display']" style={{ lineHeight: '0.85' }}>
        {/* Primeira linha - MAIOR */}
        <motion.div
            initial={{ opacity: 0, filter: "blur(20px)", y: 30 }}
            animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
            transition={{ duration: 1, delay: 0.2, ease: [0.23, 1, 0.32, 1] }}
            className="font-medium text-6xl md:text-8xl lg:text-9xl"
        >
            Criamos o novo
        </motion.div>
